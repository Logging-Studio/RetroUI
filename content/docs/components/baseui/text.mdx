---
title: Text
path: /components/baseui/text
description: Show your texts in different styles. 💅
lastUpdated: 09 Sep, 2025
links:
  source: https://github.com/logging-studio/RetroUI/blob/main/components/base-retroui/Text.tsx
---
...
<ComponentShowcase name="baseui-text-headings" />
<br />
...
<ComponentInstall>
  <ComponentInstall.Cli npmCommand="npx shadcn@latest add @retroui/baseui-text" />
...
<ComponentShowcase name="baseui-typography-p" />

---
title: Loader
path: /components/baseui/loader
description: A customizable loading indicator with bouncing squares. 🔄
lastUpdated: 20 Aug, 2025
links:
  source: https://github.com/logging-studio/RetroUI/blob/main/components/base-retroui/Loader.tsx
---

<ComponentShowcase name="baseui-loader-style-default" />
<br />
<br />

<ComponentInstall>
  <ComponentInstall.Cli npmCommand="npx shadcn@latest add @retroui/baseui-loader" />
...
<ComponentShowcase name="baseui-loader-style-solid" />
<br />
<br />

### Outline

<ComponentShowcase name="baseui-loader-style-outline" />
<br />
<br />

### Sizes

<ComponentShowcase name="baseui-loader-style-sizes" />
<br />
<br />

### Custom Configurations

<ComponentShowcase name="baseui-loader-style-custom" />
<br />
<br />
